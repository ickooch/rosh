package GitLabCLI::Environments_IF;
...
sub new {
  ...
  $this->version('1.0.0');
  $this->commands([{
		    'name' => 'lsenv',                                # external command name (used by user)
                    'verb' => [ 'list' ],
                    'usage' => \&gcli_lsenv_usage,
		   ...
		   {
		    'name' => 'descenv',                                # external command name (used by user)
                    'verb' => [ 'describe' ],
                    'usage' => \&gcli_descenv_usage,
		   ...
		   {
		    'name' => 'addenv',                                # external command name (used by user)
                    'verb' => [ 'add', 'create' ],
                    'usage' => \&gcli_addenv_usage,
		    'description' => 'add env',
                    'category' => 'env',
                    'version' => '',                                 # set when implementation is loaded
		    'kind' => 'cli',
		   ...
		   {
		    'name' => 'stopenv',                                # external command name (used by user)
                    'verb' => [ 'stop' ],
                    'usage' => \&gcli_stopenv_usage,
		    'description' => 'stop env',
                    'category' => 'env',
                    'version' => '',                                 # set when implementation is loaded
		    'kind' => 'cli',
		    'entry' => undef,                                # set when implementation is loaded
		   ...
		   {
		    'name' => 'rmenv',                                # external command name (used by user)
                    'verb' => [ 'remove', 'delete' ],
                    'usage' => \&gcli_rmenv_usage,
		   ...
		   {
		    'name' => 'editenv',                                # external command name (used by user)
                    'verb' => [ 'edit', 'update' ],
                    'usage' => \&gcli_editenv_usage,
...
#-------------------------------------------------------------------------------
sub gcli_lsenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "list env --help --long|l --short|s --format|fmt=s --in=s [ name.. ]
...
sub gcli_descenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "describe env --help --long|l --short|s --in=s 
...
sub gcli_addenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "add env --help --in=s --url=s 
...
sub gcli_stopenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "stop env --help --in=s 
...
sub gcli_rmenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "remove env --force|f --help --in=s 
...
sub gcli_editenv_usage
{
#    return "** UNIMPLEMENTED **";

    return "edit env --help --in=s --url=s 
