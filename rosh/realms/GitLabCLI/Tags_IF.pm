...
sub new {
  ...
  $this->version('1.0.0');
  $this->commands([{
		    'name' => 'lstag',                                # external command name (used by user)
                    'verb' => [ 'list' ],
                    'usage' => \&gcli_lstag_usage,
...
#-------------------------------------------------------------------------------
sub gcli_lstag_usage
{
#    return "** UNIMPLEMENTED **";

    return "list tag --help --long|l --limit=i --short|s --format|fmt=s --in=s [ name.. ]
