package ArtifactoryCLI::Users_IF;
...
#-------------------------------------------------------------------------------
sub atfcli_lsusr_usage
{
#    return "** UNIMPLEMENTED **";

    return "list user --help --long|l --format|fmt=s --short|s [ name.. ]
