...
sub new {
  ...
  $this->version('1.0.0');
  $this->commands([{
		    'name' => 'lspol',                                # external command name (used by user)
                    'verb' => [ 'list', 'ls' ],
                    'usage' => \&awscli_lspol_usage,
...
#-------------------------------------------------------------------------------
sub awscli_lspol_usage
{
#    return "** UNIMPLEMENTED **";

    return "list policy --help --long|l --format|fmt=s --short|s [ name.. ]
