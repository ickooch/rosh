...
sub new {
  ...
  $this->version('1.0.0');
  $this->commands([{
		    'name' => 'lsvpc',                                # external command name (used by user)
                    'verb' => [ 'list', 'ls' ],
                    'usage' => \&awscli_lsvpc_usage,
		   ...
		   {
		    'name' => 'descvpc',                                # external command name (used by user)
                    'verb' => [ 'describe', 'desc', 'get' ],
                    'usage' => \&awscli_descvpc_usage,
		    'description' => 'describe vpc',
                    'category' => 'vpc',
                    'version' => '',                                 # set when implementation is loaded
		    'kind' => 'cli',
		    'entry' => undef,                                # set when implementation is loaded
...
#-------------------------------------------------------------------------------
sub awscli_lsvpc_usage
{
#    return "** UNIMPLEMENTED **";

    return "list vpc --help --long|l --format|fmt=s --short|s [ name.. ]
...
sub awscli_descvpc_usage
{
#    return "** UNIMPLEMENTED **";

    return "describe vpc --help --long|l --format|fmt=s --short|s 
