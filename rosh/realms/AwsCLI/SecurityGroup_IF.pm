package AwsCLI::SecurityGroup_IF;
...
sub new {
  ...
  $this->version('1.0.0');
  $this->commands([{
		    'name' => 'lssecg',                                # external command name (used by user)
                    'verb' => [ 'list', 'ls' ],
                    'usage' => \&awscli_lssecg_usage,
		    'description' => 'list sg',
                    'category' => 'sg',
		   ...
		   {
		    'name' => 'descsecg',                                # external command name (used by user)
                    'verb' => [ 'describe', 'desc', 'get' ],
                    'usage' => \&awscli_descsecg_usage,
		    'description' => 'describe sg',
                    'category' => 'sg',
                    'version' => '',                                 # set when implementation is loaded
		    'kind' => 'cli',
		    'entry' => undef,                                # set when implementation is loaded
...
#-------------------------------------------------------------------------------
sub awscli_lssecg_usage
{
#    return "** UNIMPLEMENTED **";

    return "list sg --help --long|l --format|fmt=s --short|s [ name.. ]
...
sub awscli_descsecg_usage
{
#    return "** UNIMPLEMENTED **";

    return "describe sg --help --long|l --format|fmt=s --short|s 
