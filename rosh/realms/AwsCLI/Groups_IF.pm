...
#-------------------------------------------------------------------------------
sub awscli_lsgrp_usage
{
#    return "** UNIMPLEMENTED **";

    return "list group --help --long|l --format|fmt=s --short|s [ name.. ]
...
sub awscli_descgrp_usage
{
#    return "** UNIMPLEMENTED **";

    return "describe group --help --short|s --long|l --format|fmt=s 
